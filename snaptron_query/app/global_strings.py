...
jiq_help_incjunc = "Inclusion junction: intronic region between canonical exon and cryptic exon (ex. GT-----AG). Start and end correspond to splice site motifs (ex. GT/AG)."
jiq_help_excjunc = "Exclusion junction: intronic region between the two canonical exons (ex. GT-----AG). Start and end correspond to splice site motifs (ex. GT/AG)."
