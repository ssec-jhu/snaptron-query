    ...
    return [
        ...
        dbc.Row(
            [
                ...
                dbc.Col(components.get_text(gs.jiq_input_inc_txt),
                        width=4, className='mx-0.5', align='center', style=styles.border_column),
            ...
            dbc.Row(
                [  # align='center' for vertical alignment of the column
                    ...
                    dbc.Col(
                        ...
                        width=3, className='d-flex justify-content-start', align='center', style=styles.border_column),
                    dbc.Col(),
                    dbc.Col(  # RESET TABLE
                    ...
                    dbc.Col(  # LOCKS
                        components.get_switch_lock_data_with_table('id-switch-jiq-lock-with-table',
                                                                   'id-jiq-lock', 'id-jiq-unlock'),
                        width=1, align='center', className='d-flex justify-content-end', style=styles.border_column),
                ],
                className="g-1", justify='end'
            ),
            dmc.Space(h=10),
            dbc.Row([dbc.Container([components.get_table(table_id='id-ag-grid-jiq')],
    ...
    return dbc.Accordion([dbc.AccordionItem(
        [dbc.Row(
            [
                ...
                dbc.Col([html.Img(src='assets/junction_query.png',
...
def get_accordian_graphs_jiq():
    return dbc.Accordion([
        dbc.AccordionItem([
            dbc.Row([  # row equally divided for the plots
