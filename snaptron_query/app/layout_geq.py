    ...
    return [
        ...
        dbc.Row(
            [  # use d-flex justify-content-end to right align it horizontally, align will align vertically
                dbc.Col([components.get_text(gs.geq_gene_id)],
                        width=3, align='center', style=styles.border_column),
                ...
                dbc.Col([components_geq.get_switch_normalize()],
                        class_name='mx-3', style=styles.border_column)
            ],
            class_name="g-0 form-control-sm", align='start'
        ),
        ...
        html.Div(
            dbc.Row(
                [
                    dbc.Col([components.get_text(gs.geq_gene_coord)],
                            width=3, align='center', style=styles.border_column),
    ...
    return dbc.Accordion([dbc.AccordionItem(
        [dbc.Row(
            [
                ...
                dbc.Col([html.Img(src='assets/240318_gex.png',
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        ...
                        className='d-flex justify-content-end', align='center', style=styles.border_column),
                ],
                className="g-0 form-control-sm", style=styles.border_column,
            ),
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(  # RESET TABLE
                        ...
                        width=1, align='center', className='d-flex justify-content-end', style=styles.border_column),
                    dbc.Col(  # LOCKS
                        components.get_switch_lock_data_with_table('id-switch-geq-lock-with-table',
                                                                   'id-geq-lock', 'id-geq-unlock'),
                        width=1, align='center', style=styles.border_column,
                        className='d-flex justify-content-end'),
                ],
                className="g-1", justify='end'
            ),
            dmc.Space(h=10),
            dbc.Row([dbc.Container([components.get_table(table_id='id-ag-grid-geq')],
                                   className="ag-theme-alpine dbc dbc-ag-grid")])
        ],
        radius="md", style=styles.boundary_style,
    )
    return card
    ...
    layout = dbc.Container(
        [
            ...
            dls.Fade(show_initially=False, color='var(--bs-secondary)',
                     children=[html.Div(id="id-loading-table-geq")]),
            # GRAPHS
            dbc.Row([get_accordian_graphs_geq()], id='id-display-graphs-geq',
