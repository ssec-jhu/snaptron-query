...
class JunctionQuery:
    def __init__(
        self, exclusion_start, exclusion_end, inclusion_start, inclusion_end, meta_data_dict, df_from_snaptron
    ):
        # find the exclusion and inclusion junction rows
        self.query_mgr = jiq.JunctionInclusionQueryManager(
            exclusion_start, exclusion_end, inclusion_start, inclusion_end
        )
